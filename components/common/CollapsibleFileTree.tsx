...
export function CollapsibleFileTree({items, onFileSelected}: Props) {
    ...
    if ("items" in fileItem) {
      return (
        <Collapsible key={fileItem.name}>
          <CollapsibleTrigger className="group flex items-center data-[state=open]:text-[#F8FAFC] hover:bg-accent hover:text-accent-foreground hover:cursor-pointer w-full justify-start transition">
          ...
          <CollapsibleContent className="style-lyra:ml-4 mt-1 ml-7">
